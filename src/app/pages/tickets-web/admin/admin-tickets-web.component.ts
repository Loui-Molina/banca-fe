...
@Component({
  selector: 'app-admin-tickets-web',
  templateUrl: './admin-tickets-web.component.html',
  styleUrls: ['./admin-tickets-web.component.scss']
})
export class AdminTicketsWebComponent implements OnInit, OnDestroy {
  user: UserInterface;
  userRole = User.RoleEnum;
  loading = false;
  columns: Column[] = [{
    title: 'TICKETS.LIST.CONSORTIUM',
    key: 'consortiumName',
    showSearch: true
  }, {
