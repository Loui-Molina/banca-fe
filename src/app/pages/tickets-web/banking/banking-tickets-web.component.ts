...
@Component({
  selector: 'app-banking-tickets-web',
  templateUrl: './banking-tickets-web.component.html',
  styleUrls: ['./banking-tickets-web.component.scss']
})
export class BankingTicketsWebComponent implements OnInit, OnDestroy {
  user: UserInterface;
