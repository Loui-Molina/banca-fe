...
import {BetDto, PlayDto, PlayNumbers, ResultDto, ResultsService, TicketDto, TicketsService, User,} from 'local-packages/banca-api';
...
@Component({
  selector: 'app-consortium-tickets',
  templateUrl: './consortium-tickets.component.html',
  styleUrls: ['./consortium-tickets.component.scss']
})
export class ConsortiumTicketsComponent implements OnInit, OnDestroy {
  user: UserInterface;
