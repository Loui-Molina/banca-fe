...
@Component({
  ...
  templateUrl: './consotrium-tickets.component.html',
  styleUrls: ['./consotrium-tickets.component.scss']
})
export class ConsotriumTicketsComponent implements OnInit, OnDestroy {
  user: UserInterface;
