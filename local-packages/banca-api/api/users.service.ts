...
import { UserReq } from '../model/models';
...
export class UsersService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public userControllerSave(userReq: UserReq, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<User>;
    public userControllerSave(userReq: UserReq, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<User>>;
    public userControllerSave(userReq: UserReq, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<User>>;
    public userControllerSave(userReq: UserReq, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (userReq === null || userReq === undefined) {
            throw new Error('Required parameter userReq was null or undefined when calling userControllerSave.');
        }
