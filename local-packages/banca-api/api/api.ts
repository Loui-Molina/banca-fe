...
export const APIS = [AdminLotteriesService, BankingService, ConsortiumsService, DashboardService, DefaultService, ResultsService, TransactionsService, UsersService];
